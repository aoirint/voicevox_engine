...
def generate_licenses() -> List[License]:
    ...
    # cuda
    # license text from CUDA 11.7.1
    # https://developer.nvidia.com/cuda-11-7-1-download-archive?target_os=Windows&target_arch=x86_64&target_version=10&target_type=exe_local # noqa: B950
    # https://developer.download.nvidia.com/compute/cuda/11.7.1/local_installers/cuda_11.7.1_516.94_windows.exe # noqa: B950
    # cuda_11.7.1_516.94_windows.exe (cuda_documentation/Doc/EULA.txt)
    licenses.append(
        License(
            name="CUDA Toolkit",
            version="11.7.1",
            license=None,
            text=Path("docs/licenses/cuda/EULA.txt").read_text(encoding="utf8"),  # TODO: update EULA
        )
    )
    # cudnn
    # license text from
